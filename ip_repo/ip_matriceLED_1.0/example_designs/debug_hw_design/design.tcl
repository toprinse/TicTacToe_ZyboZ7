...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: ip_matriceLED_0, and set properties
	set ip_matriceLED_0 [ create_bd_cell -type ip -vlnv inpg.fr:user:ip_matriceLED:1.0 ip_matriceLED_0 ]
	...
	# Connect all clock & reset of ip_matriceLED_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ip_matriceLED_0/S00_AXI_LEDMATRICE]
	connect_bd_net [get_bd_pins ip_matriceLED_0/s00_axi_ledmatrice_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ip_matriceLED_0/s00_axi_ledmatrice_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to ip_matriceLED_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ip_matriceLED_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ip_matriceLED_0_S00_AXI_LEDMATRICE_* ]]
	puts $fp "set s00_axi_ledmatrice_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores inpg.fr:user:ip_matriceLED:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ip_matriceLED_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ip_matriceLED_v1_0_hw_${i}"
