...
HD_PWD='H:/5A/CE514/ZyboZ7/MatriceZyboZ7/MatriceZyboZ7.runs/design_1_my_matrice_LED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_matrice_LED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_matrice_LED_0_0.tcl
