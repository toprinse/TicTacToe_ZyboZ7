...
# XDC: imports/ZyboZ7/Zybo-Z7-Master.xdc

# Block Designs: bd/design_1/design_1.bd
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==design_1 || ORIG_REF_NAME==design_1} -quiet] -quiet

# IP: bd/design_1/ip/design_1_my_matrice_LED_0_0/design_1_my_matrice_LED_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==design_1_my_matrice_LED_0_0 || ORIG_REF_NAME==design_1_my_matrice_LED_0_0} -quiet] -quiet
