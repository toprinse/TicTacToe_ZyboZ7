...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set my_matrice_led_cmd_out_0 [ create_bd_port -dir O my_matrice_led_cmd_out_0 ]
  ...
  # Create instance: my_matrice_LED_0, and set properties
  set my_matrice_LED_0 [ create_bd_cell -type ip -vlnv inpg.fr:user:my_matrice_LED:1.0 my_matrice_LED_0 ]
  ...
  connect_bd_intf_net -intf_net PmodKYPD_0_Pmod_out [get_bd_intf_ports Pmod_out_0] [get_bd_intf_pins PmodKYPD_0/Pmod_out]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins my_matrice_LED_0/my_matrice_LED] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins PmodKYPD_0/AXI_LITE_GPIO] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net my_matrice_LED_0_my_matrice_led_cmd_out [get_bd_ports my_matrice_led_cmd_out_0] [get_bd_pins my_matrice_LED_0/my_matrice_led_cmd_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodKYPD_0/s_axi_aclk] [get_bd_pins my_matrice_LED_0/my_matrice_led_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodKYPD_0/s_axi_aresetn] [get_bd_pins my_matrice_LED_0/my_matrice_led_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_matrice_LED_0/my_matrice_LED/my_matrice_LED_reg] -force
